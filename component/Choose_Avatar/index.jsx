...
const ChooseAvatar = ({ navigation }) => {
    ...
    const handleChooseAvatarMan = () => {
        setAvatar(`https://firebasestorage.googleapis.com/v0/b/chat-app-db76c.appspot.com/o/man.png?alt=media`)
    ...
    const handleChooseAvatarWoman = () => {
        setAvatar(`https://firebasestorage.googleapis.com/v0/b/chat-app-db76c.appspot.com/o/woman.png?alt=media`)
        ...
        if (isContinue) {
            ...
            if (avatar.substring(0, 4) === 'file') {
                ...
                try {
                    ...
                    Alert.alert('Thông báo', 'Lỗi khi update ảnh', [{ text: 'OK', onPress: () => { } }])
                }
            } else {
                await updateProfile(auth.currentUser, {
                    photoURL: avatar,
        ...
        <View style={styles.container}>
            <View style={styles.main}>
                ...
                <View style={styles.defaultAvatar}>
                    <TouchableOpacity style={[styles.itemAvatar, { borderColor: isAvatarDefault }]} onPress={handleChooseAvatarDefault}>
                        <Text style={styles.textImage}>{displayName?.charAt(0).toUpperCase()}</Text>
                    </TouchableOpacity>
                ...
                <TouchableOpacity onPress={pickImage}>
                    <Image
                        style={[styles.upload, { borderColor: image ? '#0E8388cc' : 'transparent' }]}
                ...
                </TouchableOpacity>
                {
                    isLoading ? <ActivityIndicator color="gray" /> :
                        <TouchableOpacity style={[styles.btnContinue, { opacity: isContinue ? 1 : 0.5 }]} onPress={handleAddDocument} disable={!isContinue}>
